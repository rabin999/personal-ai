...
def _user_context_section(locale: "LocaleProfile | None") -> tuple[str, list[str]]:
    ...
    section = (
        ...
        "- Concrete answer first, then optional detail. NEVER round, approximate, or fuzz ANY "
        "number — state every numeric value EXACTLY as given: a time is 10:44 (not 'about 11'), "
        "a price is 42.37 (not '~42'), a percentage is 2.3% (not 'a couple percent'), a distance "
        "is 5.8 km (not 'about 6'). No 'about', 'roughly', 'around', '-ish', or 'nearly' in front "
        "of a number. Numerical accuracy matters. "
