    ...
    <div className="relative flex min-h-full items-center justify-center overflow-hidden bg-slate-50 px-6 py-12 text-slate-900 dark:bg-slate-950 dark:text-slate-100">
      ...
      <div className="relative w-full max-w-sm">
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900/60">
          {/* Primary action — the working way into the app (no real auth is wired). */}
          <button
            type="button"
            onClick={onContinue}
            className="flex w-full items-center justify-center gap-2 rounded-xl bg-indigo-600 px-4 py-3 text-sm font-semibold text-white shadow-md shadow-indigo-600/25 transition-all hover:bg-indigo-500 active:scale-[0.99]"
          >
          ...
          <form onSubmit={submit} className="mt-3 flex flex-col gap-3">
            ...
            <button
              type="submit"
              className="mt-1 flex w-full items-center justify-center rounded-lg border border-slate-300 bg-white px-4 py-2.5 text-sm font-semibold text-slate-700 transition-colors hover:bg-slate-50 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-100 dark:hover:bg-slate-700/70"
            >
        ...
        {/* Demo preview — sign-in options above are presentation-only. */}
        <p className="mx-auto mt-5 text-center text-[11px] text-slate-400 dark:text-slate-500">
          Demo preview — the sign-in options are illustrative; no account is created.
        </p>
      </div>
    </div>
  );
